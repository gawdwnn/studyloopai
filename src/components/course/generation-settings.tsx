          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>
                  Core learning content generation
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <CounterControl
                  ...
                  onChange={(value) =>
                    updateConfig({ goldenNotesCount: value })
                  }
                  min={1}
                  max={20}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <CounterControl
                  ...
                  onChange={(value) =>
                    updateConfig({ examExercisesCount: value })
                  }
                  min={1}
                  max={25}
                ...
                <CounterControl
                  ...
                  onChange={(value) =>
                    updateConfig({ mcqExercisesCount: value })
                  }
                  min={5}
                  max={50}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose the complexity of generated content
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Emphasis for content generation
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  onValueChange={([value]) =>
                    updateConfig({ summaryLength: value })
                  }
                  min={100}
                  max={1000}
                  step={50}
