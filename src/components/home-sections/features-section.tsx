...
export function FeaturesSection() {
	const features = [
		...
		},
		{
			...
			description: "Seamlessly works with your university courses and learning management systems",
	...
	return (
		<section className="py-20 bg-muted/30 bg-features">
			<div className="container mx-auto px-4">
				<div className="text-center mb-16">
					<h2 className="text-3xl font-bold mb-4">Why Students Choose StudyLoop</h2>
					<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
						Our AI-powered platform adapts to your learning style and helps you study more
						effectively, just like having a personal tutor
					</p>
				</div>
