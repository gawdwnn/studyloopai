...
export function CuecardSessionManager() {
	...
	const sortCardsByDifficulty = (cards: SpacedRepetitionCard[]): SpacedRepetitionCard[] => {
	...
	const calculateAvgPerCard = () => {
		...
		const diffMs = sessionStats.endTime.getTime() - sessionStats.startTime.getTime();
		const totalResponses = sessionStats.tooEasy + sessionStats.showAnswer + sessionStats.incorrect;
	...
	if (sessionState === "setup") {
		return <CuecardSessionSetup onStartSession={handleStartSession} onClose={handleCloseSession} />;
	}
	...
	if (sessionState === "completed") {
		...
		return <CuecardResultsView results={resultsData} onNewSession={handleCloseSession} />;
	}
