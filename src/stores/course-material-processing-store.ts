...
interface CourseMaterialProcessingActions {
	...
	getCourseMaterialProcessingJob: (materialId: string) => ProcessingJob | undefined;
...
export const useCourseMaterialProcessingStore = create<CourseMaterialProcessingStore>()(
	devtools(
...
export const useCourseMaterialProcessingCleanup = () => {
	const clearExpiredJobs = useCourseMaterialProcessingStore((state) => state.clearExpiredJobs);
	const clearAllJobs = useCourseMaterialProcessingStore((state) => state.clearAllJobs);
