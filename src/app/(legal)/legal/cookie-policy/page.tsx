		...
		<div className="container mx-auto px-4 py-8 max-w-4xl">
			...
			<div className="space-y-6">
				...
				<section>
					...
					<p className="text-muted-foreground">
						We use cookies to remember your preferences, understand how you use our website, and
				...
				<section>
					...
					<p className="text-muted-foreground">
						We use essential cookies for the website to function properly, and optional cookies to
