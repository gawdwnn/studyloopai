...
import { ArrowRight, Brain, CheckCircle, Target, TrendingUp } from "lucide-react";
	...
	return (
		<div className="container mx-auto px-4 py-12 max-w-6xl">
			...
			<div className="text-center mb-12">
				...
				<h1 className="text-4xl font-bold mb-4">Test Your Knowledge with Smart Quizzes</h1>
				<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
					Take adaptive quizzes that adjust to your performance level and focus on areas that need
					improvement for maximum learning efficiency.
				</p>
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
				<Card className="text-center">
					<CardHeader>
						...
						<CardDescription>
							Quizzes automatically adjust difficulty based on your performance and knowledge level
						</CardDescription>
					</CardHeader>
				</Card>
				...
				<Card className="text-center">
					<CardHeader>
						...
						<CardDescription>
							Get detailed explanations for each answer to understand concepts better
						</CardDescription>
					</CardHeader>
				</Card>
				...
				<Card className="text-center">
					<CardHeader>
						...
						<CardDescription>
							Track your progress and identify weak areas for focused improvement
						</CardDescription>
					</CardHeader>
				</Card>
			</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
					<Card className="text-center">
						<CardHeader>
							...
							<CardDescription>Traditional format with instant feedback</CardDescription>
						</CardHeader>
					</Card>
					<Card className="text-center">
						<CardHeader>
							<CardTitle className="text-lg">True/False</CardTitle>
							<CardDescription>Quick assessment of key concepts</CardDescription>
						</CardHeader>
					</Card>
					<Card className="text-center">
						<CardHeader>
					...
					<Card className="text-center">
						<CardHeader>
							...
							<CardDescription>AI-powered evaluation of written responses</CardDescription>
						</CardHeader>
					</Card>
				</div>
			</div>
			...
			{/* Benefits */}
			<div className="mb-12">
				<h2 className="text-3xl font-bold text-center mb-8">Why Use Our Quizzes?</h2>
					...
					<div className="space-y-4">
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-muted-foreground">AI suggests optimal times for quiz sessions</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div className="text-center bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl p-8">
				...
				<p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
					Experience adaptive learning that adjusts to your pace and helps you master any subject
					efficiently.
				</p>
