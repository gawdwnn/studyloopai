					...
					<Card className="h-64 cursor-pointer transition-transform hover:scale-105">
						<CardContent className="p-8 h-full flex items-center justify-center">
							<div className="text-center">
								<h3 className="text-xl font-semibold mb-2">What is Machine Learning?</h3>
								<p className="text-sm text-muted-foreground">Click to flip and see the answer</p>
							</div>
						</CardContent>
					</Card>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
				...
				<Card className="text-center">
					<CardHeader>
						...
						<CardDescription>
							Scientifically-proven algorithm ensures optimal retention and long-term memory
						</CardDescription>
					</CardHeader>
				</Card>
